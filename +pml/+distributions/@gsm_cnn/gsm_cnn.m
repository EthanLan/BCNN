...
classdef gsm_cnn < pml.distributions.cnn
  %% Constants
  ...
  %% Main methods
  methods
    function cnn = gsm_cnn(varargin)
      %GSM_FOE - Constructs a GSM-based FoE.
      % See help for the base class density.
      cnn = cnn@pml.distributions.cnn(varargin{:});
    end
    ...
    %% set/get learn filter indicator
    function this = set.learn_filter(this, learn_filter)
         this.learn_filter = learn_filter;
    end
    
    function learn_filter = get.learn_filter(this)
        learn_filter = this.learn_filter;
    end
